...
function buildGaugeChart(sample) {
    ...
    var gauge_trace = [
    {
        ...
        gauge: {
            ...
            bar: { color: "steelblue" },
            steps: [
            { range: [0, 1], color: 'rgba(190, 25, 30, 0.5)' },
            { range: [1, 2], color: 'rgba(190, 25, 30, 0.5)' },
            { range: [2, 3], color: 'rgba(250, 170, 40, 0.5)' },
            { range: [3, 4], color: 'rgba(250, 170, 40, 0.5)' },
            { range: [4, 5], color: 'rgba(0, 0, 0, 0.5)' },
            { range: [5, 6], color: 'rgba(0, 0, 0, 0.5)' },
            { range: [6, 7], color: 'rgba(0, 0, 100, 0.2)' },
            { range: [7, 8], color: 'rgba(0, 0, 100, 0.2)' },
